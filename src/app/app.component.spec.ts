...
describe('AppComponent', () => {
  ...
  it('should render Resources', () => {
    ...
    fixture.detectChanges();
    const compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('.content h2').textContent).toContain('Resources');
  });
  ...
  it('should render the first paragraph', () => {
    ...
    fixture.detectChanges();
    const compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('div.content > p').textContent).toContain('links to help you get started');
  });
});
